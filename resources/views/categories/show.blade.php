...
<!-- Page Container -->
            <div class="page-container ptb-60">
                <div class="container">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="widget search-form panel ptb-30 prl-20">
                                            <div class="widget-body">
                                                <form method="post" action="blog_list_left_sidebar.html#">
                    ...
                    <a href="blog_list_left_sidebar.html#">Lorem ipsum dolor sit amet consetetur</a>
                </h5>
                    ...
                    <a href="blog_list_left_sidebar.html#">Lorem ipsum dolor sit amet consetetur</a>
                                                        ...
                                                        <ul class="post-meta list-inline">
                                                            <li> <i class="ico fa fa-user mr-5"></i>John Doe</li>
                                                            <li><i class="ico fa fa-calendar mr-5"></i>14 Mar 2017</li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="recent-post media">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="widget categories-widget panel pt-20 prl-20">
                                            ...
                                            <div class="widget-body ptb-20">
                                                <ul>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">Best Deals <span>1420</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">Shopping <span>780</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">Sport <span>670</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">Travel <span>520</span></a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">Coupon Code <span>350</span></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        <div class="widget archive-widget panel pt-20 prl-20">
                                            ...
                                            <div class="widget-content ptb-20">
                                                <ul>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">August 2017</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">June 2017</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">May 2017</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">April 2017</a>
                                                    </li>
                                                    <li>
                                                        <a href="blog_list_left_sidebar.html#">March 2017</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="widget popular-tags panel pt-20 prl-20">
                                            ...
                                            <div class="widget-body pt-30 pb-20">
                                                ...
                                                <div class="tags">
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Offers</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Stores</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Shop</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Sale</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Discount</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Health</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Cloths</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Travel</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Hotels</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Deals</a>
                                                    <a href="blog_list_left_sidebar.html#" class="badge">Coupons</a>
                                                </div>
                                                ...
                                                <ul class="twitter-list">
                                                    <li class="twitter-list__item">
                                                        <p>
                                                            ...
                                                            <a href="blog_list_left_sidebar.html#">@masum_rana :</a>
    ...
    <div class="widget posted-reviews-widget panel pt-20 prl-20">
        ...
        <div class="widget-body ptb-30">
            ...
            <div class="review media">
                ...
                <div class="media-body">
                    <h5 class="mb-5">
                        <a href="blog_list_left_sidebar.html#">John Doe</a>
                        <span class="rating">
                ...
                <article class="entry panel">
                    <div class="row row-rl-0 row-tb-0 row-md-cell">
                        <div class="col-xs-12 col-md-6 col-lg-5">
                            <figure class="entry-media post-thumbnail embed-responsive embed-responsive-16by9 col-absolute-cell" data-bg-img="assets/images/blog/post_01.jpg">
        ...
        <div class="page-pagination text-center mt-30 p-10 panel">
            <nav>
                ...
                <ul class="page-pagination">
                    <li><a class="page-numbers previous" href="blog_list_left_sidebar.html#">Previous</a>
                    </li>
                    <li><a href="blog_list_left_sidebar.html#" class="page-numbers">1</a>
                    </li>
                    <li><span class="page-numbers current">2</span>
                    </li>
                    <li><a href="blog_list_left_sidebar.html#" class="page-numbers">3</a>
                    </li>
                    <li><a href="blog_list_left_sidebar.html#" class="page-numbers">4</a>
                    </li>
                    <li><span class="page-numbers dots">...</span>
                    </li>
                    <li><a href="blog_list_left_sidebar.html#" class="page-numbers">20</a>
                    </li>
                    <li><a href="blog_list_left_sidebar.html#" class="page-numbers next">Next</a>
                    </li>
                </ul>
                <!-- End Page Pagination -->
            </nav>
