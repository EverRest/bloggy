                                    ...
                                    <div class="col-xs-12">
                                        <div class="deal-single panel">
                                            <div class="row row-rl-0 row-sm-cell">
                                                <div class="col-sm-5">
                                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9 col-absolute-cell" data-bg-img="{{URL::asset($quote->photo)}}">
                                                        ...
                                                        {{--<ul class="deal-actions top-15 right-20">--}}
                                                            ...
                                                            {{--<li class="share-btn">--}}
                                                                {{--<div class="share-tooltip fade">--}}
                                                                    {{--<a target="_blank" href="deals_list.html#"><i class="fa fa-facebook"></i></a>--}}
                                                                    {{--<a target="_blank" href="deals_list.html#"><i class="fa fa-twitter"></i></a>--}}
                                                                    {{--<a target="_blank" href="deals_list.html#"><i class="fa fa-google-plus"></i></a>--}}
                                                                    {{--<a target="_blank" href="deals_list.html#"><i class="fa fa-pinterest"></i></a>--}}
                                                                {{--</div>--}}
                                                    ...
                                                    <div class="bg-white pt-20 pl-20 pr-15">
                                                        <div class="pr-md-10">
                                                            ...
                                                            <h3 class="deal-title mb-10">
                                                                <a href="{{url('/qoute')}}">{{$quote->author}}</a>
                                                            </h3>
                                                            ...
                                                            {{--</ul>--}}
                                                            <p class="text-muted mb-20">{{$quote->content}}
                                                                @if(Auth::user()->id == $quote->user_id)
                                                                    <form action="{{url('/quote/destroy/' . $quote->id)}}" method="POST">
                                                                        {{ csrf_field() }}
                                                                        @if ($errors->any())
                        ...
                        <div class="page-pagination text-center mt-30 p-10 panel">
                            <nav>
                                ...
                                <ul class="page-pagination">
                                    <li><a class="page-numbers previous" href="deals_list.html#">Previous</a>
                                    </li>
                                    <li><a href="deals_list.html#" class="page-numbers">1</a>
                                    </li>
                                    <li><span class="page-numbers current">2</span>
                                    </li>
                                    <li><a href="deals_list.html#" class="page-numbers">3</a>
                                    </li>
                                    <li><a href="deals_list.html#" class="page-numbers">4</a>
                                    </li>
                                    <li><span class="page-numbers dots">...</span>
                                    </li>
                                    <li><a href="deals_list.html#" class="page-numbers">20</a>
                                    </li>
                                    <li><a href="deals_list.html#" class="page-numbers next">Next</a>
                                    </li>
                                </ul>
                                <!-- End Page Pagination -->
                            </nav>
                        ...
                        <div class="row row-tb-10">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="widget best-rated-deals panel pt-20 prl-20">
                                    <h3 class="widget-title h-title">Best Rated Quotes</h3>
                                    <div class="widget-body ptb-30">


                                        <div class="media">
                                            <div class="media-left">
                                                <a href="deals_list.html#">
                                                    <img class="media-object" src="assets/images/deals/thumb_01.jpg" alt="Thumb" width="80">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="mb-5">
                                                    <a href="deals_list.html#">Aenean ut orci vel massa</a>
                                                </h6>
                                                <div class="mb-5">
                                                            <span class="rating">
                                        ...
                                        {{--<ul class="twitter-list">--}}
                                            {{--<li class="twitter-list__item">--}}
                                                {{--<p>--}}
                                                    ...
                                                    {{--<a href="deals_list.html#">@masum_rana :</a>--}}
                                ...
                                {{--<div class="widget posted-reviews-widget panel pt-20 prl-20">--}}
                                    ...
                                    {{--<div class="widget-body ptb-30">--}}
                                        ...
                                        {{--<div class="review media">--}}
                                            ...
                                            {{--<div class="media-body">--}}
                                                {{--<h5 class="mb-5">--}}
                                                    {{--<a href="deals_list.html#">John Doe</a>--}}
                                                    {{--<span class="rating">--}}
