                        ...
                        <div class="row row-tb-30">
                                    ...
                                    {{--<div class="contact-info">--}}
                                        ...
                                        {{--<ul class="social-icons social-icons--colored list-inline">--}}
                                            {{--<li class="social-icons__item">--}}
                                                {{--<a href="contact_us_02.html#"><i class="fa fa-facebook"></i></a>--}}
                                            {{--</li>--}}
                                            {{--<li class="social-icons__item">--}}
                                                {{--<a href="contact_us_02.html#"><i class="fa fa-twitter"></i></a>--}}
                                            {{--</li>--}}
                                            {{--<li class="social-icons__item">--}}
                                                {{--<a href="contact_us_02.html#"><i class="fa fa-linkedin"></i></a>--}}
                                            {{--</li>--}}
                                            {{--<li class="social-icons__item">--}}
                                                {{--<a href="contact_us_02.html#"><i class="fa fa-google-plus"></i></a>--}}
                                            {{--</li>--}}
                                            {{--<li class="social-icons__item">--}}
                                                {{--<a href="contact_us_02.html#"><i class="fa fa-pinterest"></i></a>--}}
                                            {{--</li>--}}
                                        {{--</ul>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            ...
                            <div class="col-xs-12">
                                <div class="contact-area-col contact-form">
                                    <h3 class="t-uppercase h-title mb-20">Add link</h3>
                                    <form action="{{url('/link/store')}}" method="post">
                                        @if ($errors->any())
                                        ...
                                        @if( Auth::user()->id )
                                            ...
                                            {{--<div class="form-group">--}}
                                                {{--<label>Name</label>--}}
                                                <input name="user_id" type="hidden" value="{{Auth::user()->id}}"  required="required">
                                            {{--</div>--}}
                                            <div class="form-group">
                                                <label>Name</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description" id="description" rows="5" class="form-control" required="required"></textarea>
                                            </div>
