                    ...
                    <section class="section coupons-area coupons-area-list">
                        ...
                        <div class="row row-masnory row-tb-20">
                            @if(!empty($posts))
                                    ...
                                    <div class="col-xs-12">
                                        <div class="coupon-single panel t-center t-sm-left">
                                            ...
                                            <div class="row row-sm-cell row-tb-0 row-rl-0">
                                                <div class="col-sm-5">
                                                    <figure class="p-15">
                                                        <img class="store-logo" src="{{$post->picture}}" alt="">
                                                    </figure>
                                                </div>
                                                <!-- end col -->
                                                <div class="col-sm-7">
                                                    <div class="panel-body">
                                                        ...
                                                        <p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>{{getdate(strtotime($post->created_at))['mday']}} {{substr(getdate(strtotime($post->created_at))['month'], 0, 3)}}  {{getdate(strtotime($post->created_at))['year']}}</p>
                                                        <p>{{substr($post->content, 0, 100)}}...</p>
                                                        <div class="showcode">
                                                            <a href="{{url('/post/' . $post->id)}}" class="show-code btn btn-sm btn-block">Details</a>
                                                            {{--<button class="show-code btn btn-sm btn-block" data-toggle="modal" data-target="#coupon_0">Details</button>--}}
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                                ...
                                                <div class="modal-content panel">
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row row-v-10">
                                                            ...
                                                            <div class="col-md-10 col-md-offset-1">
                                                                <a href="coupons_list.html#" class="btn btn-link">Visit Our Store</a>
                                                            </div>
                                                            <div class="col-md-10 col-md-offset-1">
                                                                <h6 class="color-mid t-uppercase">Click below to get your coupon code</h6>
                                                                <a href="coupons_list.html#" target="_blank" class="coupon-code">X455-17GT-OL58</a>
                                                            </div>
                                                            <div class="col-md-10 col-md-offset-1">
                                                                <div class="like-report mb-10">
                                                                    ...
                                                                    <ul class="list-inline social-icons social-icons--colored mt-10">
                                                                        <li class="social-icons__item">
                                                                            <a href="coupons_list.html#"><i class="fa fa-facebook"></i></a>
                                                                        </li>
                                                                        <li class="social-icons__item">
                                                                            <a href="coupons_list.html#"><i class="fa fa-twitter"></i></a>
                                                                        </li>
                                                                        <li class="social-icons__item">
                                                                            <a href="coupons_list.html#"><i class="fa fa-google-plus"></i></a>
                                                                        </li>
                                                                        <li class="social-icons__item">
                                                                            <a href="coupons_list.html#"><i class="fa fa-linkedin"></i></a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer footer-info t-center ptb-40 prl-30">
                                                        ...
                                                        <form method="post" action="coupons_list.html#">
                                ...
                                @endforeach
                            @else
                                <h3>We can not find anything.</h3>
                            @endif
                            {{--<div class="col-xs-12">--}}
                                {{--<div class="coupon-single panel t-center t-sm-left">--}}
                                    {{--<div class="row row-sm-cell row-tb-0 row-rl-0">--}}
                                        ...
                                        {{--<div class="col-sm-7">--}}
                                            {{--<div class="panel-body">--}}
                                                ...
                                                {{--</ul>--}}
                                                {{--<h5 class="deal-title mb-10">--}}
                                                    {{--<a href="coupons_list.html#">15% off 2 select Amazon Fire cases</a>--}}
                                                {{--</h5>--}}
                                    ...
                                    {{--<div class="row row-sm-cell row-tb-0 row-rl-0">--}}
                                        ...
                                        {{--<div class="col-sm-7">--}}
                                            {{--<div class="panel-body">--}}
                                                ...
                                                {{--</ul>--}}
                                                {{--<h5 class="deal-title mb-10">--}}
                                                    {{--<a href="coupons_list.html#">Flat 40% off hotel bookings in 10 cities</a>--}}
                                                {{--</h5>--}}
                                                {{--<p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>--}}
                                                {{--<div class="showcode">--}}
                                    ...
                                    {{--<div class="row row-sm-cell row-tb-0 row-rl-0">--}}
                                        ...
                                        {{--<div class="col-sm-7">--}}
                                            {{--<div class="panel-body">--}}
                                                ...
                                                {{--</ul>--}}
                                                {{--<h5 class="deal-title mb-10">--}}
                                                    {{--<a href="coupons_list.html#">There is no place like home 25% off</a>--}}
                                                {{--</h5>--}}
                                                {{--<p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>--}}
                                                {{--<div class="showcode">--}}
                                    ...
                                    {{--<div class="row row-sm-cell row-tb-0 row-rl-0">--}}
                                        ...
                                        {{--<div class="col-sm-7">--}}
                                            {{--<div class="panel-body">--}}
                                                ...
                                                {{--</ul>--}}
                                                {{--<h5 class="deal-title mb-10">--}}
                                                    {{--<a href="coupons_list.html#">10% off $399+ refurbished laptops</a>--}}
                                                {{--</h5>--}}
                                                {{--<p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>--}}
                                                {{--<div class="showcode">--}}
                                    ...
                                    {{--<div class="row row-sm-cell row-tb-0 row-rl-0">--}}
                                        ...
                                        {{--<div class="col-sm-7">--}}
                                            {{--<div class="panel-body">--}}
                                                ...
                                                {{--</ul>--}}
                                                {{--<h5 class="deal-title mb-10">--}}
                                                    {{--<a href="coupons_list.html#">10% off select XPS & Alienware laptops</a>--}}
                                                {{--</h5>--}}
                                                {{--<p class="mb-15 color-muted font-12"><i class="lnr lnr-clock mr-10"></i>Expires in 1 day 30 hours</p>--}}
                                                {{--<div class="showcode">--}}
                        ...
                        <div class="page-pagination text-center mt-30 p-10 panel">
                            <nav>
                                ...
                                <ul class="page-pagination">
                                    <li><a class="page-numbers previous" href="coupons_list.html#">Previous</a>
                                    </li>
                                    <li><a href="coupons_list.html#" class="page-numbers">1</a>
                                    </li>
                                    <li><span class="page-numbers current">2</span>
                                    </li>
                                    <li><a href="coupons_list.html#" class="page-numbers">3</a>
                                    </li>
                                    <li><a href="coupons_list.html#" class="page-numbers">4</a>
                                    </li>
                                    <li><span class="page-numbers dots">...</span>
                                    </li>
                                    <li><a href="coupons_list.html#" class="page-numbers">20</a>
                                    </li>
                                    <li><a href="coupons_list.html#" class="page-numbers next">Next</a>
                                    </li>
                                </ul>
                                <!-- End Page Pagination -->
                            </nav>
                                                    ...
                                                    <ul class="deal-actions top-10 left-10">
                                                        ...
                                                        <li class="share-btn">
                                                            <div class="share-tooltip fade">
                                                                <a target="_blank" href="coupons_list.html#"><i class="fa fa-facebook"></i></a>
                                                                <a target="_blank" href="coupons_list.html#"><i class="fa fa-twitter"></i></a>
                                                                <a target="_blank" href="coupons_list.html#"><i class="fa fa-google-plus"></i></a>
                                                                <a target="_blank" href="coupons_list.html#"><i class="fa fa-pinterest"></i></a>
                                                            </div>
                                        ...
                                        <ul class="twitter-list">
                                            <li class="twitter-list__item">
                                                <p>
                                                    ...
                                                    <a href="coupons_list.html#">@masum_rana :</a>
                                ...
                                <div class="widget posted-reviews-widget panel pt-20 prl-20">
                                    ...
                                    <div class="widget-body ptb-30">
                                        ...
                                        <div class="review media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="mb-5">
                                                    <a href="coupons_list.html#">John Doe</a>
                                                    <span class="rating">
