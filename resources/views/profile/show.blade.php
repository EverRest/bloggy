            ...
            <div class="row row-rl-10 row-tb-20">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                <a href="">
                                                    ...
                                                    <img id="avatar" src="@if (empty($user->avatar)) {{'https://i.ytimg.com/vi/a0CDJZu4M5I/movieposter.jpg'}} @else {{  url($user->avatar) }} @endif" alt="avatar"/>
                                                </a>
                                                <hr />
                                            </div>
                                            <div class="col-xs-4">
                ...
                <div class="page-content col-sm-8 col-md-9">
                    <div class="contact-area-col contact-form">
                        <h3 class="t-uppercase h-title mb-20"><span>{{$user->name}}</span> profile</h3>
                        {{--<form id="profile-form" action="{{ url('/profile') }}" method="POST" enctype="multipart/form-data">--}}
                            ...
                            {{--@if( $user->id )--}}
                                ...
                                {{--<div class="form-group">--}}
                                    {{--<label>Name</label>--}}
                                    {{--<input type="text" name="name" id="name" class="form-control bg-white" required="required" value="{{$user->name}}">--}}
                                {{--</div>--}}
                                {{--<div class="form-group hidden">--}}
                                {{--<div class="form-group upload-sec" style="display:none;">--}}
                                    {{--<form action="/upload-target" class="dropzone">--}}
                                    {{--<label>Avatar</label>--}}
                                    {{--<input type="file" name="avatar" id="photo" class="form-control bg-white" value="{{$user->avatar}}">--}}
                                    {{--</form>--}}
                                {{--</div>--}}
                                {{--<hr>--}}
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <h3>Job: </h3>
                                    <p>
                                        <strong>{{!empty($user->job)? $user->job : 'blogger...'}}</strong>
                                    </p>
                                </div>
                                <hr>
                                <hr>
                                ...
                                <div class="form-group">
                                    <h3>About: </h3>
                                    <p>
                                        <strong>{{!empty($user->job)? $user->about : 'Few words about me...'}}</strong>
                                    </p>
                                </div>
                                <hr>
                                <hr>
