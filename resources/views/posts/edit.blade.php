                    ...
                    <div class="row row-tb-20">
                        ...
                        <div class="col-xs-12 col-md-12">
                            @if (!empty($post))
                                ...
                                <h3 class="t-uppercase h-title mb-20">Edit the post</h3>
                                {{--<form action="{{url()->current()}}" method="POST" enctype="multipart/form-data">--}}
                                {{--{{ Form::open(array('action' => array('PostController@update', $post->id), 'method' => "post")) }}--}}
                                <form action="{{url('/post/save')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    @if( Auth::user()->id )
                                        ...
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" name="title" id="title" class="form-control" required="required" value="{{$post->title}}">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        {{--<div class="form-group">--}}
                                            {{--<label>Hashtag</label>--}}
                                            <input type="hidden" name="tags" id="tags" class="form-control" required="required" value="{{$post->tags}}">
                                        {{--</div>--}}
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Content</label>
                                            <textarea rows="5" name="content" id="content" class="form-control" required="required">{{$post->content}}</textarea>
                                        </div>
