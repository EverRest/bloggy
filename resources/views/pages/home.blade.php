                        ...
                        <div class="col-xs-12 col-md-4 col-lg-3">
                            <aside>
                                <ul class="nav-coupon-category panel">
                                    ...
                                    {{--</li>--}}
                                            @foreach($cats as $cat)
                                                <li><a href="{{url('category/'.$cat->id)}}"><i class="fa fa-plane"></i>{{$cat->title}}<span>{{count($cat->posts)}}</span></a>
                                                </li>
                                            @endforeach
                                    @endif
                                    <li class="all-cat">
                                        <a class="font-14" href="index.html#">All Blogs</a>
                                    </li>
                                </ul>
                            </aside>
                        </div>
                        <div class="col-xs-12 col-md-8 col-lg-9">
                            <div class="header-deals-slider owl-slider" data-loop="true" data-autoplay="true" data-autoplay-timeout="10000" data-smart-speed="1000" data-nav-speed="false" data-nav="true" data-xxs-items="1" data-xxs-nav="true" data-xs-items="1" data-xs-nav="true" data-sm-items="1" data-sm-nav="true" data-md-items="1" data-md-nav="true" data-lg-items="1" data-lg-nav="true">
                                ...
                                <div class="deal-single panel item">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{!! URL::asset('images/deals/thumb_01.jpg') !!}">
                                ...
                                <div class="deal-single panel item">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{!! URL::asset('images/deals/thumb_02.jpg') !!}">
                                ...
                                <div class="deal-single panel item">
                                    <figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{!! URL::asset('images/deals/thumb_03.jpg') !!}">
                                        <div class="label-discount top-10 right-10">-30%</div>
                                        <ul class="deal-actions top-10 left-10">
                                            <li class="like-deal">
                                                    <span>
                    ...
                    <div class="row row-rl-10">
                            ...
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pr-10" src="{!! URL::asset('images/icons/tablet.png') !!}" alt="">
                                    </div>
                                    <div class="col-xs-8">
                        ...
                        <div class="col-md-4">
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pr-10" src="{!! URL::asset('images/icons/online-shop-6.png') !!}" alt="">
                                    </div>
                                    <div class="col-xs-8">
                        ...
                        <div class="col-md-4">
                            <div class="item panel prl-15 ptb-20">
                                <div class="row row-rl-5 row-xs-cell">
                                    <div class="col-xs-4 valign-middle">
                                        <img class="pr-10" src="{!! URL::asset('images/icons/money.png') !!}" alt="">
                                    </div>
                                    <div class="col-xs-8">
                    ...
                    {{--<div class="row row-masnory row-tb-20">--}}
                        ...
                        {{--</span>--}}
                                    ...
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_01.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                        ...
                        {{--</span>--}}
                                    {{--</div>--}}
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_02.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                                {{--<div class="bg-white pt-20 pl-20 pr-15">--}}
                                    {{--<div class="pr-md-10">--}}
                        ...
                        {{--</span>--}}
                                    {{--</div>--}}
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_03.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                                {{--<div class="bg-white pt-20 pl-20 pr-15">--}}
                                    {{--<div class="pr-md-10">--}}
                        ...
                        {{--<div class="col-sm-6 col-lg-4">--}}
                            {{--<div class="deal-single panel">--}}
                                {{--<figure class="deal-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{!! URL::asset('images/deals/thumb_04.jpg') !!}">--}}
                        ...
                        {{--</span>--}}
                                    {{--</div>--}}
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_04.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                                {{--<div class="bg-white pt-20 pl-20 pr-15">--}}
                                    {{--<div class="pr-md-10">--}}
                        ...
                        {{--</span>--}}
                                    {{--</div>--}}
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_05.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                                {{--<div class="bg-white pt-20 pl-20 pr-15">--}}
                                    {{--<div class="pr-md-10">--}}
                        ...
                        {{--</span>--}}
                                    {{--</div>--}}
                                    {{--<div class="deal-store-logo">--}}
                                        {{--<img src="{!! URL::asset('images/brands/brand_06.jpg') !!}" alt="">--}}
                                    {{--</div>--}}
                                {{--</figure>--}}
                                {{--<div class="bg-white pt-20 pl-20 pr-15">--}}
                                    {{--<div class="pr-md-10">--}}
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_01.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_02.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_03.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_04.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_05.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                        ...
                        <div class="coupon-item">
                            <div class="coupon-single panel t-center">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="text-center p-20">
                                            <img class="store-logo" src="{!! URL::asset('images/coupons/coupon_06.jpg') !!}" alt="">
                                        </div>
                                        <!-- end media -->
                                    </div>
                                    <!-- end col -->
                    ...
                    <div class="popular-stores-slider owl-slider" data-loop="true" data-autoplay="true" data-smart-speed="1000" data-autoplay-timeout="10000" data-margin="20" data-items="2" data-xxs-items="2" data-xs-items="2" data-sm-items="3" data-md-items="5" data-lg-items="6">
                        ...
                        <div class="store-item t-center">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="{!! URL::asset('images/brands/brand_07.jpg') !!}" alt="">
                                    </div>
                                </div>
                        ...
                        <div class="store-item t-center">
                            <a href="store_single_01.html" class="panel is-block">
                                <div class="embed-responsive embed-responsive-4by3">
                                    <div class="store-logo">
                                        <img src="{!! URL::asset('images/brands/brand_08.jpg') !!}" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="row row-tb-20">
                        ...
                        <div class="blog-post col-xs-12 col-sm-6 col-md-4">
                            <article class="entry panel">
                                <figure class="entry-media post-thumbnail embed-responsive embed-responsive-16by9" data-bg-img="{!! URL::asset('images/blog/post_01.jpg') !!}">
                    ...
                    <div class="newsletter-form">
                        ...
                        <form method="post" action="{{url('/subscribe')}}">
                            <div class="input-group mb-10">
                                <input name="email" id="email" type="email" class="form-control bg-white" placeholder="Email Address" required="required">
