...
<!-- PAGE TITLE                                -->
<!-- ––––––––––––––––––––––––––––––––––––––––– -->
<title>BLOGGY | News, Things, Huckes and making money Template</title>
...
<!-- PAGE FAVICON                              -->
<!-- ––––––––––––––––––––––––––––––––––––––––– -->
<link rel="apple-touch-icon" href="{!! URL::asset('images/favicon/apple-touch-icon.png') !!}">
...
<!-- Linearicons -->
<link href="{!! URL::asset('vendors/linearicons/css/linearicons.css') !!}" rel="stylesheet">

<!-- Owl Carousel -->
<link href="{!! URL::asset('vendors/owl-carousel/owl.carousel.min.css') !!}" rel="stylesheet">
<link href="{!! URL::asset('vendors/owl-carousel/owl.theme.min.css') !!}" rel="stylesheet">

<!-- Flex Slider -->
<link href="{!! URL::asset('vendors/flexslider/flexslider.css') !!}" rel="stylesheet">
